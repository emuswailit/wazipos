    ...
    return (
        <Modal visible={isOpen} animationType="slide" transparent={true}>
            <View className="flex-1 justify-center items-center p-4 bg-black/60 backdrop-blur-sm">
                <View className="w-full max-w-sm rounded-2xl p-6 shadow-2xl items-center flex-col bg-white dark:bg-slate-900">
                    ...
                    <Text style={{ fontFamily: theme.font.bold, fontSize: theme.fontSize.lg, color: theme.text }} className="uppercase text-center tracking-wide">
                    ...
                    <Text style={{ fontFamily: theme.font.regular, fontSize: theme.fontSize.sm }} className="text-center mt-1 font-semibold px-2 text-slate-500 dark:text-slate-400">
                    ...
                    {(statusStage === 'SENDING' || statusStage === 'WAITING') && (
                        <Text style={{ fontFamily: theme.font.mono, fontSize: theme.fontSize.xs }} className="text-slate-400 mt-3 uppercase tracking-wider">
                    ...
                    {(statusStage === 'FAILED' || statusStage === 'SUCCESS') && (
                        <TouchableOpacity onPress={onClose} className={`w-full h-10 rounded-xl items-center justify-center mt-5 active:scale-95 shadow-sm ${statusStage === 'SUCCESS' ? 'bg-emerald-500' : 'bg-blue-600'}`}>

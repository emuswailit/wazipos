...
export interface AutocompleteOption {
    ...
    label: string;
    sublabel?: string;
    search?: string;              // optional extra text to match on
    meta?: Record<string, any>;   // arbitrary extras carried through
}

export interface MultiSelectAutocompleteProps {
    /** Selected option ids, controlled by the parent */
    value: string[];
    /** Fires whenever selection changes */
    onChange: (ids: string[]) => void;

    /**
     * Load options. Called once when the picker opens.
     * If you pass a search-aware loader, debounce inside it.
     * Return the full option list (client-side filtering is also supported).
     */
    loadOptions: (query?: string) => Promise<AutocompleteOption[]>;

    /** When true, filter `loadOptions` results client-side by the search text */
    clientFilter?: boolean;

    /** Display labels for already-selected ids (avoids refetch flicker) */
    ...
    /** Only fire loadOptions when the picker is opened. Default: true */
    lazy?: boolean;
}

// components/admin/frequencies/AdminFrequenciesMobileView.tsx
//
// Mobile card view for the admin frequencies list.
...
export function AdminFrequenciesMobileView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
function FrequencyCard({
    ...
    return (
        ...
        >
            ...
            >
                Latin: {item.latin || '—'} ({item.numerical}x daily)
            </Text>
...
export default AdminFrequenciesMobileView;
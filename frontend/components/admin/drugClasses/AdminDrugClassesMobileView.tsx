// components/admin/drugClasses/AdminDrugClassesMobileView.tsx
...
export function AdminDrugClassesMobileView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
export default AdminDrugClassesMobileView;
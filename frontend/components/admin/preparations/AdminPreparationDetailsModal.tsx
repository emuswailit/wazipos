// components/admin/preparations/AdminPreparationDetailsModal.tsx
...
export default function AdminPreparationDetailsModal({
    routeItem,
    onClose,
    theme,
    formatDateHandler,
                    ...
                    <View className="w-full max-w-2xl mx-auto flex-col gap-y-6">
                        ...
                        >
                            <Text
                                ...
                                className="text-[10px] uppercase font-black tracking-wider mb-2"
                            >
                                Supplemental Dosage Context Guidelines
                            </Text>
                            <Text
                                style={{
                                    color: theme.text,
                            ...
                            >
                                {routeItem?.description ||
                                    'No specific systemic indicators or combination guidelines submitted for this record parameters profile.'}
                            </Text>
                        </View>

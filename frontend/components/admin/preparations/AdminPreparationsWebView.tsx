// components/admin/preparations/AdminPreparationsWebView.tsx
...
const COLUMNS: { label: string; flex: number }[] = [
    { label: 'Preparation', flex: 2.2 },
    { label: 'Formulation', flex: 1.6 },
    { label: 'Generics', flex: 2.4 },
    { label: 'Description', flex: 2.6 },
    { label: 'Created', flex: 1.2 },
    { label: 'Actions', flex: 1.4 },
];

type Props = AdminPreparationsSharedProps;

function rowKey(item: PreparationItem): string {
    return item.id || String(Math.random());
}

export function AdminPreparationsWebView({
    query,
    setQuery,
    onRefresh,
    refreshing,
                    ...
                    {items.length === 0 ? (
                        emptyComponent ?? (
                            <View className="p-8 items-center">
                                ...
                                >
                                    No preparations match the filters.
                                </Text>
                            </View>
                        )
                    ) : (
...
export default AdminPreparationsWebView;
// components/admin/preparations/AdminPreparationsMobileView.tsx
...
export function AdminPreparationsMobileView({
    query,
    setQuery,
    onRefresh,
    refreshing,
    ...
    return (
        ...
        >
            ...
            <Text
                ...
                numberOfLines={2}
            >
                Compounds: {item.generics_string}
            </Text>
...
export default AdminPreparationsMobileView;
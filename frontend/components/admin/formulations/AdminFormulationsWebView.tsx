// components/admin/formulations/AdminFormulationsWebView.tsx
//
// Web table view for the admin formulations list.
//
...
const COLUMNS: { label: string; flex: number }[] = [
    { label: 'Formulation', flex: 2.2 },
    { label: 'Galenic / Medium Brief', flex: 4.0 },
...
export function AdminFormulationsWebView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
export default AdminFormulationsWebView;
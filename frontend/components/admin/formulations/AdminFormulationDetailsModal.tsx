// components/admin/formulations/AdminFormulationDetailsModal.tsx
//
// Admin read-only details modal for a formulation.
//
// Mirrors the retailer FormulationDetailsModal 1:1 — same header,
// same two-card body, same action row, same copy.
...
import type { FormulationItem } from './types';
...
export default function AdminFormulationDetailsModal({
    routeItem,
    onClose,
    theme,
    formatDateHandler,
                    ...
                    <View className="w-full max-w-2xl mx-auto flex-col gap-y-6">
                        ...
                        >
                            <Text
                                ...
                                className="text-[10px] uppercase font-black tracking-wider mb-2"
                            >
                                Galenic Properties / Intake medium
                                summary
                            </Text>
                            <Text
                                style={{
                            ...
                            >
                                {routeItem?.description ||
                                    'No specific formulation descriptors submitted for this record profile parameter.'}
                            </Text>
                        </View>

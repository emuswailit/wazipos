// app/(admin)/drug-categories/AdminDrugCategoriesMobileView.tsx
//
// Mobile card view for the admin drug categories list.
//
// Renders below the 768px breakpoint. Cards show title,
// description, dates, and the Edit / Details action pair.
...
import type {
    AdminDrugCategoriesSharedProps,
    DrugCategoryItem,
} from './AdminDrugCategoriesList';
import { StatusPill } from './AdminDrugCategoriesWebView';

type Props = AdminDrugCategoriesSharedProps;

function rowKey(item: DrugCategoryItem): string {
    return item.id || String(Math.random());
}

export function AdminDrugCategoriesMobileView({
    query,
    setQuery,
    onRefresh,
    refreshing,
        ...
        >
            ...
            >
                ...
                <TextInput
                    ...
                    placeholder="Search drug categories..."
                ...
                ListEmptyComponent={
                    emptyComponent ?? (
                        <View className="p-8 items-center">
                            ...
                            >
                                No drug categories match the filters.
                            </Text>
                        </View>
                    )
                }
...
export default AdminDrugCategoriesMobileView;
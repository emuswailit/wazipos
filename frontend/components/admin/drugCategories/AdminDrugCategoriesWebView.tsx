// app/(admin)/drug-categories/AdminDrugCategoriesWebView.tsx
//
// Web table view for the admin drug categories list.
//
// Every color, font, and size comes from AuthContext's theme.
//
...
export function AdminDrugCategoriesWebView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
export default AdminDrugCategoriesWebView;
// components/admin/drugSubClasses/AdminDrugSubClassesWebView.tsx
//
// Web table view for the admin drug sub classes list.
//
...
const COLUMNS: { label: string; flex: number }[] = [
    { label: 'Subclass Name', flex: 2.0 },
    { label: 'Drug Class Group', flex: 1.8 },
    { label: 'Clinical Indication Summary', flex: 3.0 },
...
export function AdminDrugSubClassesWebView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
export default AdminDrugSubClassesWebView;
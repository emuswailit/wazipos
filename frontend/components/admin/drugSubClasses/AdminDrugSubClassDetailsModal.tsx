// components/admin/drugSubClasses/AdminDrugSubClassDetailsModal.tsx
//
// Admin read-only details modal for a drug sub class.
//
// Matches the retailer SubClassDetailsModal 1:1 — same header
// badge, same three cards, same action row.
...
import type { DrugSubClassItem } from "./types";
...
export default function AdminDrugSubClassDetailsModal({
    routeItem,
    onClose,
    theme,
    formatDateHandler,
                    ...
                    <View className="w-full max-w-2xl mx-auto flex-col gap-y-6">
                        ...
                        >
                            <View className="items-start min-w-[140px]">
                                ...
                                >
                                    Parent Drug Class Linkage
                                </Text>
                                <View
                                    className="px-3 py-1 rounded-lg mt-2 self-start"
                                    style={{
                                        backgroundColor:
                        ...
                        >
                            <Text
                                ...
                                className="text-[10px] uppercase font-black tracking-wider mb-2"
                            >
                                Pharmacological Actions & Indications
                            </Text>
                            <Text
                                style={{
                                    color: theme.text,
                            ...
                            >
                                {routeItem?.description ||
                                    "No specific clinical indicators submitted for this structural node profile parameter."}
                            </Text>
                        </View>

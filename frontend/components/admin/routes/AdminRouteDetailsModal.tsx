// components/admin/routes/AdminRouteDetailsModal.tsx
//
// Admin read-only details modal for a route.
//
// Matches the retailer RouteDetailsModal 1:1 — same header badge,
// same two-card body, same action row.
...
import type { DrugRouteItem } from './types';
...
export default function AdminRouteDetailsModal({
    routeItem,
    onClose,
    theme,
    formatDateHandler,
                        ...
                        >
                            ...
                            >
                                {routeItem?.description ||
                                    'No clinical log summaries recorded for this deployment profile node.'}
                            </Text>
                        </View>

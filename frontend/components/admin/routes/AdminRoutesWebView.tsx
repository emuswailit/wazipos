// components/admin/routes/AdminRoutesWebView.tsx
//
// Web table view for the admin routes list.
//
...
export function AdminRoutesWebView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
export default AdminRoutesWebView;
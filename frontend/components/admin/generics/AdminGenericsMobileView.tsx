// components/admin/generics/AdminGenericsMobileView.tsx
//
// Mobile card view for the admin generics list.
...
export function AdminGenericsMobileView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
export default AdminGenericsMobileView;
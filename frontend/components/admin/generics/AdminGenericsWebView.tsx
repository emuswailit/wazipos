// components/admin/generics/AdminGenericsWebView.tsx
//
// Web table view for the admin generics list.
//
...
const COLUMNS: { label: string; flex: number }[] = [
    { label: 'Compound Name', flex: 2.0 },
    { label: 'Drug Class', flex: 1.5 },
    { label: 'Subclass', flex: 1.5 },
    { label: 'Pharmacology Description', flex: 2.4 },
    { label: 'Created On', flex: 1.2 },
    { label: 'Actions', flex: 1.4 },
];

type Props = AdminGenericsSharedProps;

function rowKey(item: GenericItem): string {
    return item.id || String(Math.random());
}

export function AdminGenericsWebView({
    query,
    setQuery,
    onRefresh,
    refreshing,
...
export default AdminGenericsWebView;